...
def compute_neighborhood_robustness(trials: list[Any], space: Any | None = None, radius_steps: int = 1, min_neighbors: int = 1) -> dict[int, float | None]:
...
def analyze(trials: list[Any], space: Any | None = None, radius_steps: int = 1, min_neighbors: int = 1) -> dict[str, object]:
    ...
    return {
        ...
        'diagnostics': [] if valid else [{'code': 'ROBUSTNESS_INSUFFICIENT_NEIGHBORS', 'severity': 'warning', 'message': 'No trials had enough evaluated neighbors'}],
    }
