...
class OptimizerConfig:
    algorithm: Literal['grid','adaptive_grid','random','genetic','bayesian','walk_forward'] = 'grid'
    seed: int = 42
    ...
    selection_mode: Literal['best_objective','best_after_constraints','balanced','robust','conservative','aggressive','pareto','pareto_knee','custom'] = 'best_after_constraints'
    ...
    pareto_knee_method: Literal['distance_to_ideal','max_curvature','normalized_elbow'] = 'distance_to_ideal'
    ...
    constraints_merge_mode: Literal['custom_overrides_auto','merge_auto_and_custom','custom_only'] = 'custom_overrides_auto'
    ...
    def to_dict(self):
        d=asdict(self); d['output_dir']=str(self.output_dir); return d
