...
class OptimizerResult:
    ...
    diagnostics:list=field(default_factory=list); analysis:dict[str,object]=field(default_factory=dict); baseline_trial:Trial|None=None; baseline_comparison:dict[str,object]=field(default_factory=dict)
